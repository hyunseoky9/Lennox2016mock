...
for i = 1:length(af)
	...
	xf0 = xf0r*(1-lf*af(i));
	xfsig2 = 2;
	sigf = xfsig2*(1-lf^2*af(i)^2);
	factorf = lf*(1-af(i))*x0r/(1-af(i)*lf);
	...
	param = [timeline,a,x0r,x0,xsig2,sig,lf,af(i),xf0r,xf0,xfsig2,sigf,factorf,lr,ar,xr0r,xr0,xrsig2,sigr,...
